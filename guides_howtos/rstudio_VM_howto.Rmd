...
**From your EC2 console:**                 
   1. Make sure region is Oregon 
    ...
    5. Select the AMI you want to spin up (I usually go with *RStudio-1.0.153_R-3.4.1_Julia-0.6.0_ubuntu-16.04-LTS-64bit*)
    6. Choose the instance type you want (I generally go with m4.4xlarge when I have to do any serious computation)
        Review & Launch
